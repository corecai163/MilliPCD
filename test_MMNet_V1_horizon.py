...
if __name__ == '__main__':
    ...
    test_dataset = DatasetUofSC('../UofSC_Horizon')
    ...
    for data in test_data_loader:
        ...
        savemat("horizon/result"+str(step)+".mat", gen_data)
        step = step + 1
    print(loss_g/len(test_dataset))
save_txt("horizon/chd_loss.txt",np.array(each_chd))
save_txt("horizon/emd_loss.txt",np.array(each_emd))
